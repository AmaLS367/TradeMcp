...
| **Dune** | ⛓️ On-chain analytics (via MCP Market) | API key in marketplace |
...
| **Chainlink** | Chainlink feed and protocol data | ![Auth](https://img.shields.io/badge/Auth-None-brightgreen) |
