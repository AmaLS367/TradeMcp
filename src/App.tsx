        ...
        <Card className="glass-card border-none shadow-2xl">
          <CardHeader className="text-center pt-10 pb-6">
            <motion.div
              ...
              className="mx-auto w-16 h-16 bg-gradient-to-br from-primary/20 to-primary/5 rounded-2xl flex items-center justify-center mb-5 ring-1 ring-primary/10"
            >
          ...
          <CardContent className="px-8 pb-10 space-y-5">
            <p className="text-[11px] text-center text-muted-foreground/50 uppercase tracking-[0.2em] font-medium">
              Sign in to continue
            </p>

            <Button
              className="w-full h-12 rounded-xl text-[15px] font-semibold bg-primary hover:shadow-xl hover:shadow-primary/20 transition-all duration-300"
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-card/40 px-3 text-muted-foreground/40 tracking-wider">or</span>
              </div>
            </div>

            <Button
              variant="outline"
              className="w-full h-12 rounded-xl text-[15px] font-semibold transition-all duration-300 border-border/30 hover:bg-accent/50 hover:border-border/60"
...
export function AuthGuard({ children }: { children?: React.ReactNode } = {}) {
  ...
  return children ? <>{children}</> : <DashboardLayout user={user} />;
}
